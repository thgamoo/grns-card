...
const supportZones = [
  {
    name: "군영",
    note: "손패. 출정, 보급병 배치, 문지기 배치가 이루어지는 시작점.",
  },
  {
    name: "징집소",
    note: "덱. 게임 시작 시 40장으로 구성하고, 0장이되면 즉시 패배",
  },
  {
    name: "후방기지",
    note: "아직 보급하지 않은 보급병이 머무는 곳. 공격, 이동, 장악 시 1장을 전진기지로 옮기면서 보급함. (사용하지 않은 자원)",
  },
  {
    name: "전진기지",
    note: "보급에 사용된 카드가 이동하는 곳 (사용한 자원)",
  },
  {
    name: "매장지",
    note: "쓰러진 카드가 가는 공개 더미. 성주가 이곳으로 가면 패배",
  },
  {
    name: "야생",
    note: "퇴출 당한 카드들이 가는 구획",
  },
];
...
const fieldTerms: FieldTerm[] = [
  {
    name: "전장",
    note: "최대 야전병 5장을 배치할 수 있음. 공격, 이동, 장악 판단이 일어나는 전투 중심 구획.",
    showOnField: true,
  },
  {
    name: "성",
    note: "문지기 4장과 성주 1장을 포함하는 구획. 문지기 자리 4곳을 장악당하면 패배.",
    showOnField: true,
  },
