...
images:
  cover: "docs/card-assets/illustrations/ob01/ob01-0004.png"
  selected:
    - "docs/card-assets/illustrations/ob01/ob01-0004.png"
  references: []
  generated: []
image_generation:
  reference_images:
...
인간 호랑이 주술사를 첫성문 앞의 작은 전쟁 의식으로 그린다. 카드 효과의 규칙 제스처가 장면 안에서 자연스럽게 보이게 한다.
